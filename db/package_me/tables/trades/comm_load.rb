...
table :comm_load do
  col :load_id, type: :int, id: true, business_id: true, identity: true
  ...
  col :account_ind, type: :char, len: 1
  col :purchase_code, type: :char, len: 1
  col :quantity, type: :money
  col :comm_type_old, len: 2
  col :file_id, type: :int
  col :fund_process_date
  col :settle_test_flag, type: :char, len: 1
  ...
  col :network_ind, type: :char, len: 1
