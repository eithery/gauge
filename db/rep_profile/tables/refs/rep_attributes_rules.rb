...
table :rep_attributes_rules do
  ...
  col :rep_attribute_name, computed: { function: :get_rep_attribute, params: :rep_attribute_id }
  col :contract_type_id, :ref => :repContractTypes
  col :contract_type_name, computed: { function: :get_contract_type, params: :contract_type_id }
