  ...
  module DB
    module Constraints
      describe ForeignKeyConstraint do
        let(:foreign_key) { ForeignKeyConstraint.new('FK_Trade_Primary_Reps', :direct_trades, :rep_code, :primary_reps, :code) }
        ...
        describe '#table' do
          it "equals to the table name passed in the initializer in various forms" do
            ...
            .each do |table_name, actual_table|
              foreign_key = ForeignKeyConstraint.new('fk_trades_primary_reps', table_name, :rep_code, :primary_reps, :code)
